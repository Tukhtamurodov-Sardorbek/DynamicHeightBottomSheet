...
class SheetPositionData {
  ...
  double get relativeToSheetHeight {
    return pixels / _calculator.maxHeight;
  }
  ...
  double get relativeToSnappingPositions {
    double minSnappingPos = _calculator.getSmallestPositionPixels();
    double maxSnappingPos = _calculator.getBiggestPositionPixels();
